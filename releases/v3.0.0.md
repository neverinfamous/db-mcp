# v3.0.0 — Major Architectural Upgrades & Strict OAuth 2.1

## Highlights

- 20 new tools across Core, Admin, Stats, JSON, Introspection, and Server Audit groups.
- Migrated Code Mode execution to native `isolated-vm` for V8 memory separation.
- Secured prototype freezing, disabled string code generation, and blocked constructor chain escapes.
...
**Full Changelog**: [v2.0.0...v3.0.0](https://github.com/neverinfamous/db-mcp/compare/v2.0.0...v3.0.0)

## Install

```bash
npm install db-mcp@3.0.0
```

## Docker Image

```bash
docker pull writenotenow/db-mcp:v3.0.0
```
