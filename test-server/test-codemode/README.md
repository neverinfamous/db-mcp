...
| `sqlite.help()`                                                 | `totalMethods` reflects 162 tools         | `totalMethods` reflects 135 tools                                     |
...
| `test-codemode-admin.md`            | admin         | 30N/30W                                                                  |
...
**Total**: 162 Native / 135 WASM tools across 10 groups + 1 sandbox prompt + 1 WASM degradation prompt.
