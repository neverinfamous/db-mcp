...
- `sqlite_spatialite_query [NATIVE ONLY]`
- `sqlite_spatialite_analyze [NATIVE ONLY]`
- `sqlite_spatialite_index [NATIVE ONLY]`
- `sqlite_spatialite_transform [NATIVE ONLY]`
- `sqlite_spatialite_import [NATIVE ONLY]`
