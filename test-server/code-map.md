...
| `test-server/tool-reference.md`              | Tool inventory (172N/145W group+audit; 175N/148W MCP total) with [Tool Count Taxonomy](test-server/tool-reference.md#tool-count-taxonomy) and descriptions |
