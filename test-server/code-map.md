...
| `test-server/tool-reference.md`              | Tool inventory (175N/148W group+audit; 179N/152W MCP total) with [Tool Count Taxonomy](test-server/tool-reference.md#tool-count-taxonomy) and descriptions |
