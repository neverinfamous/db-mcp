...
const POSITIONAL_PARAM_MAP: Record<string, string | string[]> = {
  ...
  set: ["table", "column", "path", "value"],
  remove: ["table", "column", "path"],
  insert: ["table", "column"],
  update: ["table", "column"],
  select: ["table", "column"],
  query: ["table", "column"],
  merge: ["table", "column"],
  validatePath: ["table", "column", "path"],
  analyzeSchema: ["table", "column"],
  valid: ["table", "column"],
  type: ["table", "column"],
  arrayLength: ["table", "column"],
  ...
  textSplit: ["table", "column", "delimiter"],
  textConcat: ["table", "columns"],
  textReplace: ["table", "column", "searchPattern", "replaceWith"],
