...
const MIGRATIONS_TABLE = "_mcp_migrations";

// =============================================================================
// Input Schemas
// =============================================================================

const MigrationInitSchema = z.object({}).default({});
...
const MigrationApplySchema = MigrationRecordSchema;
...
const MigrationStatusSchema = z.object({}).default({});

// =============================================================================
// Output Schemas
// =============================================================================

const MigrationRecordEntry = z.object({
  id: z.number(),
  version: z.string(),
...
const MigrationInitOutputSchema = z.object({
  success: z.boolean(),
...
const MigrationRecordOutputSchema = z.object({
  success: z.boolean(),
  record: MigrationRecordEntry.optional(),
  error: z.string().optional(),
});

const MigrationApplyOutputSchema = z.object({
  success: z.boolean(),
  record: MigrationRecordEntry.optional(),
  error: z.string().optional(),
});

const MigrationRollbackOutputSchema = z.object({
  success: z.boolean(),
...
const MigrationHistoryOutputSchema = z.object({
  success: z.boolean(),
...
const MigrationStatusOutputSchema = z.object({
  success: z.boolean(),
 ...
 */
async function isMigrationTableInitialized(
