 ...
 */
export function getResourceDefinitions(adapter: SqliteAdapter): ResourceDefinition[] {
    return [
...
function createSchemaResource(adapter: SqliteAdapter): ResourceDefinition {
    return {
        name: 'sqlite_schema',
        uri: 'sqlite://schema',
        description: 'Get the full database schema including all tables, columns, and indexes',
