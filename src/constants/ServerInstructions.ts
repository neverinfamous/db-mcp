...
| \`sqlite_list_tables\` | List tables (excludeSystemTables hides SpatiaLite; views via sqlite_list_views) |
...
// Note: sqlite_json_normalize_column defaults to text output; use outputFormat: 'preserve' to keep JSONB
\`\`\`
