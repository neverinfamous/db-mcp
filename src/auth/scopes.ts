 ...
 */
export function parseTableScope(scope: string): { database: string; table: string } | null {
 ...
 */
export function scopeGrantsToolAccess(scope: string, toolName: string): boolean {
 ...
 */
export function scopesGrantToolAccess(scopes: string[], toolName: string): boolean {
 ...
 */
export function scopeGrantsDatabaseAccess(scope: string, databaseName: string): boolean {
 ...
 */
export function scopesGrantDatabaseAccess(scopes: string[], databaseName: string): boolean {
...
export function getRequiredScopeForGroup(group: ToolGroup): string {
    if (ADMIN_SCOPE_GROUPS.includes(group) && !WRITE_SCOPE_GROUPS.includes(group)) {
        return 'admin';
    }
    if (WRITE_SCOPE_GROUPS.includes(group) && !READ_SCOPE_GROUPS.includes(group)) {
        return 'write';
    }
    return 'read';
}
