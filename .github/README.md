...
- **`copilot-instructions.md`**: Custom instructions for GitHub Copilot to enforce project-specific coding standards.
- **`dependabot.yml`**: Configuration for automated dependency updates via Dependabot.
