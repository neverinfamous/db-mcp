...
describe("Core Tools - Datetime", () => {
  ...
  describe("sqlite_date_add", () => {
    beforeEach(async () => {
      await adapter.executeWriteQuery("CREATE TABLE test_dates (id INTEGER, dt TEXT)");
      await adapter.executeWriteQuery("INSERT INTO test_dates (id, dt) VALUES (1, '2023-01-01 12:00:00'), (2, '2023-01-02 12:00:00')");
    });
  ...
  describe("sqlite_date_diff", () => {
    beforeEach(async () => {
      await adapter.executeWriteQuery("CREATE TABLE test_dates (id INTEGER, start_dt TEXT, end_dt TEXT)");
      await adapter.executeWriteQuery("INSERT INTO test_dates (id, start_dt, end_dt) VALUES (1, '2023-01-01 12:00:00', '2023-01-02 12:00:00')");
    });
    ...
    it("should apply limit correctly", async () => {
      await adapter.executeWriteQuery("INSERT INTO test_dates (id, start_dt, end_dt) VALUES (2, '2023-01-01', '2023-01-03')");
      const res = await tools.get("sqlite_date_diff")?.({
        table: "test_dates",
        column1: "end_dt",
        column2: "start_dt",
