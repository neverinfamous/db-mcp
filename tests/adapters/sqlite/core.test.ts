...
describe('Core Tools', () => {
    ...
    describe('sqlite_list_tables', () => {
        it('should list tables', async () => {
            ...
            const result = await tools.get('sqlite_list_tables')?.({}) as { tables: { name: string }[] };
    ...
    describe('sqlite_describe_table', () => {
        it('should describe table columns', async () => {
            await adapter.executeWriteQuery('CREATE TABLE items (id INTEGER PRIMARY KEY, name TEXT)');
    ...
    describe('sqlite_create_index', () => {
        it('should create an index', async () => {
            await adapter.executeWriteQuery('CREATE TABLE indexed (id INTEGER, name TEXT)');
